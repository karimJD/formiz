...
const PreviousButton = (props) => {
  ...
  return (
    <Button bgColor={isDarkTheme ? 'gray.600' : 'gray.50'} _hover={{ bgColor: isDarkTheme ? 'gray.700' : 'gray.200' }} _active={{ bgColor: isDarkTheme ? 'gray.800' : 'gray.400' }} size="sm" onClick={form.prevStep} variant="ghost" {...props}>
      Previous
    </Button>
  );
};
